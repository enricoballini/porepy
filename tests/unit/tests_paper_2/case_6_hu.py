...
class GeometryCase3(pp.ModelGeometry):
    def set_geometry(self) -> None:
        ...
        # exporter = pp.Exporter(self.mdg, "mdg_I_hope", "./case_6/")
        # exporter.write_pvd()
        # exporter.write_vtu()
        # pdb.set_trace()
...
if __name__ == "__main__":
    ...
    os.system("mkdir -p ./case_6/hu/")
    os.system("mkdir -p ./case_6/hu/BETA")
    folder_name = "./case_6/hu/visualization"
