...
"""
let's plot the convergence only for case 1 slanted, if you want more get your hands dirty with the code
"""
...
if ppu:
    root_paths = [
        ...
        "./case_1/slanted_ppu/convergence_results/",
    ]
    # root_paths = [
    #     "./case_1/non-conforming/slanted_hu/convergence_results/",
    #     "./case_1/non-conforming/slanted_ppu/convergence_results/",
    # ]
