...
class InitialConditionCase2PPU(case_2_hu.InitialConditionCase2):
...
if __name__ == "__main__":
    ...
    os.system("mkdir -p ./case_2/ppu/")
    os.system("mkdir -p ./case_2/ppu/BETA")
    folder_name = "./case_2/ppu/visualization"
