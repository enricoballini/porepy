...
- linear solver is the bottleneck for small mesh size, but it is only related to the PPU, so I can use small meshes here

"""


class InitialConditionCase1SlantedConvergence(
...
class SolutionStrategyCase1SlantedConvergence(
...
class GeometryCase1SlantedConvergence(pp.ModelGeometry):
...
class PartialFinalModel(
    ...
    InitialConditionCase1SlantedConvergence,
    SolutionStrategyCase1SlantedConvergence,
    GeometryCase1SlantedConvergence,
    pp.DataSavingMixin,
):
    """ """
...
if __name__ == "__main__":
    ...
    class FinalModel(PartialFinalModel):
        def __init__(self, params: Optional[dict] = None):
            ...
            self.root_path = "./case_1/slanted_hu/convergence_results/"
            # self.root_path = (
    ...
    os.system("mkdir -p ./case_1/slanted_hu/convergence_results/BETA")

    np.savetxt(
        "./case_1/slanted_hu/convergence_results/cell_sizes",
        cell_sizes,
    )
    # np.savetxt(
    #     "./case_1/non-conforming/slanted_hu_Kn"
    ...
    for cell_size in cell_sizes:
        ...
        folder_name = "./case_1/slanted_hu/convergence_results/visualization_" + str(
            cell_size
        )
        # folder_name = (
        #     "./case_1/non-conforming/slanted_hu_Kn"
