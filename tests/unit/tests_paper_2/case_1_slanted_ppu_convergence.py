...
- linear solver is the bottleneck for small mesh size, but it is only related to the PPU
...
if __name__ == "__main__":
    ...
    os.system("mkdir -p ./case_1/slanted_ppu/convergence_results")
    # os.system(
    ...
    np.savetxt(
        "./case_1/slanted_ppu/convergence_results/cell_sizes",
        cell_sizes,
    )
    # np.savetxt(
    #     "./case_1/non-conforming/slanted_ppu_Kn"
    ...
    for cell_size in cell_sizes:
        ...
        folder_name = "./case_1/slanted_ppu/convergence_results/visualization_" + str(
            cell_size
        )
