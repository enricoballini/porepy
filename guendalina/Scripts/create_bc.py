...
# Valori degli stress da report Tabella pag 10)
...
e0 = phi/(1-phi)
b=-1.16434
a = log10(0.01367*2*10**(0.467) )#-1.58548

# Calcolo cm
cm_under = 10**(a+b*np.log10(under_stress))
cm = 10**(a+b*np.log10(stress))
cm_over = 10**(a+b*np.log10(over_stress))
...
dest_fpath='/scratch1/Diana/tesi_polito/Guendalina/BaseCase/RUN_0'
os.makedirs(dest_fpath, exist_ok=True)
shutil.copy2(src2, dest_fpath)

#Sostituisco i parametri nel file copiato
with open('/scratch1/Diana/tesi_polito/Guendalina/BaseCase/RUN_0/GUE2022_TESI.data','r') as file:
    filedata = file.read()
...
#Salvo il file
with open('/scratch1/Diana/tesi_polito/Guendalina/BaseCase/RUN_0/GUE2022_TESI.data','wt') as file:
    file.write(filedata)

# Creo l'input per Eclipse
# Copio il file parametrizzato
src2 = '/scratch1/Diana/tesi_polito/Guendalina/BC_FILES/GUE2022_UPP2_TESI.DATA'
shutil.copy2(src2, '/scratch1/Diana/tesi_polito/Guendalina/BaseCase/RUN_0')    
...
f = open('/scratch1/Diana/tesi_polito/Guendalina/BaseCase/RUN_0/ROCKTABH.INC','w')
f.write('ROCKTABH\n')
